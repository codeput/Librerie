...
#include <inttypes.h>
#if defined (__AVR_ATtiny85__) || (__AVR_ATtiny2313__) || (__AVR_ATtiny84__)
...
#if defined (__AVR_ATtiny85__) || (__AVR_ATtiny2313__) || (__AVR_ATtiny84__)   // Replaced Wire calls with ATtiny TWI calls
